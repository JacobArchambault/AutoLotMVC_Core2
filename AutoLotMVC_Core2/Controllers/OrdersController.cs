...
namespace AutoLotMVC_Core2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var autoLotContext = _context.Orders.Include(o => o.Car).Include(o => o.Customer);
            return View(await autoLotContext.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CarId,Id,Timestamp")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
